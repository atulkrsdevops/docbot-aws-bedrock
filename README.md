...
├── scripts/
│   ├── upload_docs.py    # Upload docs to S3 + sync KB
│   └── test_chat.py      # CLI test client
├── ui/
...
```bash
# Interactive mode
python scripts/test_chat.py --api-url https://xxxxx.execute-api.us-east-1.amazonaws.com/prod/
